    ...
    <div className="relative min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="glass-card p-8">
          ...
          {!showOTP ? (
            <form onSubmit={(e) => { e.preventDefault(); if (!isLogin) setShowOTP(true); }}>
              <div className="space-y-4">
                ...
                {!isLogin && (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-bold text-secondary">Welcome Bundle!</p>
                      <p className="text-sm text-muted-foreground">Get 200 bananas free on signup</p>
                    </div>
                  </motion.div>
                )}

                <button type="submit" className="btn-jungle w-full flex items-center justify-center gap-2 text-lg">
                  {isLogin ? "🔓 Enter the Jungle" : "🌿 Join the Pack"}
            ...
            >
              ...
              <p className="text-muted-foreground text-sm mb-6">
                Wise Owl sent a 6-digit code to your email
              </p>
              ...
              <button className="btn-jungle w-full mb-4 text-lg">
                ✅ Verify & Enter
              </button>
          ...
          {!showOTP && (
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors font-bold">
