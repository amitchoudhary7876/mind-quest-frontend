        ...
        <div className="glass-card p-8">
          ...
          {!showOTP ? (
              ...
              <div className="space-y-4">
                ...
                {!isLogin && (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/20"
                  >
                    <Gift className="w-8 h-8 text-yellow-400 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-yellow-400">Welcome Bonus!</p>
            ...
            >
              ...
              <h3 className="font-display text-xl font-semibold mb-2">Verify Your Email</h3>
              ...
              <button className="btn-neon w-full mb-4">
                Verify & Continue
              </button>
          ...
          {!showOTP && (
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 py-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
